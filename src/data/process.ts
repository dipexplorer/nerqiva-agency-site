...
export const PROCESS_STEPS: ProcessStep[] = [
  ...
  },
  {
    ...
    timeframe: "1-2 Weeks",
    description: "Powered by AI-accelerated workflows, we write clean, performant, type-safe code at extreme velocity. We implement secure database schemas, scale query performance, and set up clear code documentation.",
